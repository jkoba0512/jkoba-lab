...
sections:
  - block: markdown
    content:
      ...
      text: |-
        ...
        **jkoba Lab** は、九州工業大学 大学院情報工学研究院 知能情報工学研究系の小林順が主宰する研究室です。

        生物の運動制御に着想を得たロボティクスを研究しています。神経計算、人の運動、身体力学の知見をもとに、実世界で柔軟に動作するロボットとその制御器を設計します。
    design:
      columns: '1'
  ...
  - block: markdown
    content:
      ...
      text: |-
        研究テーマは [Research](/jkoba-lab/ja/#section-focus-areas)、論文一覧は [Publications](/jkoba-lab/ja/publications/)、メンバーは [People](/jkoba-lab/ja/people/) をご覧ください。
